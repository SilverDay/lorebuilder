...
Router::get('/api/v1/users/me',              [UserController::class, 'profile']);
Router::patch('/api/v1/users/me',              [UserController::class, 'updateProfile']);
Router::post('/api/v1/users/me/email',        [UserController::class, 'changeEmail']);
Router::post('/api/v1/users/me/email/verify', [UserController::class, 'verifyEmail']);
Router::delete('/api/v1/users/me',              [UserController::class, 'deleteAccount']);
...
// Trash routes must be registered before :id to avoid "trash" matching :id
Router::get('/api/v1/worlds/:wid/entities/trash',          [EntityController::class, 'trash']);
Router::post('/api/v1/worlds/:wid/entities/:id/restore',    [EntityController::class, 'restore']);
